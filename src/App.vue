...
<script>
  ...
  export default {
    ...
    beforeUpdate:function () {
      ...
      if(_this.html.indexOf("/Sseeltement") != -1  || _this.html.indexOf("/register") != -1 || _this.html.indexOf("/login") != -1   || _this.html.indexOf("/orderLogisticsMore3") != -1 || _this.html.indexOf("/orderLogisticsMore2") != -1 || _this.html.indexOf("/haveCar") != -1 || _this.html.indexOf("/newProlist") != -1 || _this.html.indexOf("/xinYaIndex") != -1 || _this.html.indexOf("/orderLogistics/orderLogisticsMore") != -1){
        $("#appBox").hide();
      }else{
        $("#appBox").show();
      }
