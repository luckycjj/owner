...
<script>
  ...
  export default {
    ...
    beforeUpdate:function () {
      ...
      if(_this.html.indexOf("/login") != -1 || _this.html.indexOf("/haveCar") != -1 || _this.html.indexOf("/newProlist") != -1 || _this.html.indexOf("/xinYaIndex") != -1 || _this.html.indexOf("/orderLogistics/orderLogisticsMore") != -1){
        $("#appBox").hide();
      }else{
        $("#appBox").show();
      }
