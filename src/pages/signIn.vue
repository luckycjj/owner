        ...
        $.ajax({
          ...
          success: function (getGoodsDetail) {
            if(getGoodsDetail.success == "1"){
              _this.startJ = getGoodsDetail.deliAddr == null || getGoodsDetail.deliAddr.addressLatAndLon == undefined ? "" : getGoodsDetail.deliAddr.addressLatAndLon.split(",")[0] ;
              _this.startW = getGoodsDetail.deliAddr == null || getGoodsDetail.deliAddr.addressLatAndLon == undefined ? "" : getGoodsDetail.deliAddr.addressLatAndLon.split(",")[1] ;
              _this.endJ = getGoodsDetail.arriAddr == null || getGoodsDetail.arriAddr.addressLatAndLon == undefined ? "" : getGoodsDetail.arriAddr.addressLatAndLon.split(",")[0] ;
              _this.endW = getGoodsDetail.arriAddr == null || getGoodsDetail.arriAddr.addressLatAndLon == undefined ? "" : getGoodsDetail.arriAddr.addressLatAndLon.split(",")[1] ;
              _this.mapDriver();
