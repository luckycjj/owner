 ...
 */
  ...
  MeScroll.prototype.extendDownScroll = function(optDown) {
    ...
    MeScroll.extend(optDown, {
      ...
      offset: 50, //在列表顶部,下拉大于80px,松手即可触发下拉刷新的回调
      ...
      onMoving: function(mescroll, rate, downHight) {
        ...
        if(mescroll.downProgressDom) {
          ...
          mescroll.downProgressDom.style.webkitTransform = "rotate(0deg)";//"rotate(" + progress + "deg)";
          mescroll.downProgressDom.style.transform = "rotate(0deg)";//"rotate(" + progress + "deg)";
        }
      },
